...
phone = 18385092934
passwd = "01090011"
# login.login(phone, passwd, captchaVerification)
# data = login.login(phone, passwd, captchaVerification)
...
# 打印已保存的JSON数据
# print(login_data_loaded)
# print(login_data_loaded['data']['userId'])
# print(login_data_loaded['data']['userName'])
# print(login_data_loaded['data']['phonenumber'])
# print(login_data_loaded['data']['sexName'])
# print(login_data_loaded['data']['schoolName'])
# print(login_data_loaded['data']['collegeName'])
# print(login_data_loaded['data']['majorName'])
# print(login_data_loaded['data']['className'])
# print(login_data_loaded['data']['teacherName'])
# print(login_data_loaded['data']['enterpriseId'])
# print(login_data_loaded['data']['enterpriseName'])
# print(login_data_loaded['data']['studentCode'])
# print(login_data_loaded['data']['token'])
# print(login_data_loaded['data']['expTime'])
